...
@pytest.mark.parametrize(
    ...
    [(1, "1.000000e+00"), (1e-77, "1.000000e-77")]
)
...
@pytest.mark.parametrize(
    "test_predictions,expected_output", [
        (
                np.array([[[3.3954e-01, 6.3595e-01, 2.4509e-02]],
                          [[9.8928e-01, 1.0667e-02, 4.8996e-05]]]),
                np.array([['3.395400e-01,6.359500e-01,2.450900e-02'],
...
def test_format_probability_string__various_dimensions(input_shape: int, expected_output_shape: int):
