...
try:
    import openeye
    from .OEMolGraph import MolGraph, get_atom_fdim
except ImportError:
    from .RDKitMolGraph import MolGraph, get_atom_fdim

from .featurization_utils import SMILES_TO_GRAPH, get_bond_fdim
