...
from chemprop.featurizers import get_available_features_generators
...
class TrainArgs(CommonArgs):
    ...
    split_type: Literal['random', 'scaffold_balanced', 'predetermined', 'crossval', 'cv', 'cv-no-test', 'index_predetermined', 'random_with_repeated_smiles', 'kmeans', 'kennard_stone'] = 'random'
