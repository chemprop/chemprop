...
- ``RIGR``: This configuration is designed to featurize the molecular graph using only the resonance-invariant atom and bond features which are included in the default atom and bond featurizers.""",
    )
    featurization_args.add_argument(
        "--keep-h",
        action="store_true",
