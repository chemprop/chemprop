...
def predict(model: MoleculeModel,
    ...
    for batch in tqdm(data_loader, disable=disable_progress_bar, leave=False):
        ...
        mol_batch, features_batch, atom_descriptors_batch, atom_features_batch, bond_descriptors_batch = \
            batch.batch_graph(), batch.features(), batch.atom_descriptors(), batch.atom_features(), batch.bond_descriptors()
