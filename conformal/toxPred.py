...
#python3 ../predict.py --test_path data/tox21.csv --checkpoint_dir tox21_checkpoints2 --preds_path tox21_preds_conformal_adaptive_alpha05.csv --calibration_method conformal_adaptive --calibration_path data/tox21small.csv --alpha 0.5
