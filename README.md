...
* **Kennard-Stone** Strictly enforces model interpolation during training to better asses capacity for inference. Useful for high-dimensional and/or small datasets, this algorithm attempts to sample feature space uniformly into the training set. Usage: `--split_type kennard_stone`
