...
We assume you are using ``anaconda`` or ``miniconda`` to set up your local environment, but you may adapt these steps use any virtual environment manager you like (e.g. ``mamba``):
