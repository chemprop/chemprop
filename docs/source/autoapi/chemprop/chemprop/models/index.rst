:py:mod:`chemprop.chemprop.models`
==================================

.. py:module:: chemprop.chemprop.models
...
.. autoapisummary::
   ...
   chemprop.chemprop.models.MPNN
   chemprop.chemprop.models.MulticomponentMPNN
...
.. autoapisummary::
   ...
   chemprop.chemprop.models.load_model
   chemprop.chemprop.models.save_model



.. py:class:: MPNN(message_passing, agg, predictor, batch_norm = True, metrics = None, w_t = None, warmup_epochs = 2, init_lr = 0.0001, max_lr = 0.001, final_lr = 0.0001)
...
.. py:function:: load_model(path, multicomponent)


.. py:function:: save_model(path, model, input_scalers, output_scaler)
